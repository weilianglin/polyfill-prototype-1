...
function _main(i1, i2) {
 ...
 while (1) {
  ...
  i12 = i6;
  while (1) {
   i13 = ((i11 | 0) / (i8 | 0) | 0) + i10 | 0;
   if (i13 >>> 0 > 1e3) i14 = (i13 >>> 0) / (i9 >>> 0) | 0; else i14 = i13;
   if (!(i11 & 3)) i15 = i14 + (Math_imul((i11 & 7 | 0) == 0 ? 1 : -1, i11) | 0) | 0; else i15 = i14;
   i13 = i15 << 16 >> 16;
   i16 = (Math_imul(i13, i13) | 0) & 255;
   i17 = i16 + (i12 & 65535) | 0;
   i11 = i11 + 1 | 0;
   if ((i11 | 0) == 2e4) break; else {
    i10 = i15;
    i12 = i17;
   }
  }
  i10 = i7 + 1 | 0;
  if ((i10 | 0) == 7e3) break; else {
   i5 = i15;
   i6 = i17;
   i7 = i10;
  }
