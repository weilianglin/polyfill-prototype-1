...
__ATINIT__.push();
memoryInitializer = "copy.f32.js.mem";
...
function _printf_core(i1, i2, i3, i4, i5) {
 ...
 L1 : while (1) {
  ...
  while (1) {
   ...
   i46 = i45 + 1 | 0;
   i44 = HEAP8[3629 + (i43 * 58 | 0) + i47 >> 0] | 0;
   i47 = i44 & 255;
   if ((i47 + -1 | 0) >>> 0 < 8) {
    i45 = i46;
    i43 = i47;
    ...
    do if (i55 >>> 0 < 2146435072 | (i55 | 0) == 2146435072 & 0 < 0) {
     ...
     if ((i56 | 0) == 97) {
      ...
      while (1) {
       i114 = ~~d107;
       i115 = i113 + 1 | 0;
       HEAP8[i113 >> 0] = HEAPU8[4093 + i114 >> 0] | i45;
     ...
     if (!(i180 & 32)) ___fwritex(i113 ? (i106 ? 4153 : 4157) : i106 ? 4145 : 4149, 3, i1) | 0;
  ...
  L313 : do if ((i36 | 0) == 64) {
   ...
   if (!((i33 | 0) == 0 & (i55 | 0) == 0)) {
    ...
    while (1) {
     i55 = i45 + -1 | 0;
     HEAP8[i55 >> 0] = HEAPU8[4093 + (i106 & 15) >> 0] | i47;
...
function _main(i1, i2) {
 ...
 while (1) {
  ...
  i10 = (i6 | 0) % 255 | 0;
  i11 = (i6 | 0) % 15 | 0;
  i12 = ((i6 | 0) % 120 | 0 | 0) % 1024 | 0;
  i13 = ((i6 | 0) % 1024 | 0) + i6 | 0;
  i14 = ((i9 | 0) % 1024 | 0) + i9 | 0;
  i9 = ((i11 | 0) % 1024 | 0) + i11 | 0;
  i11 = (((i10 | 0) % 1024 | 0) + i10 + i12 | 0) % 1024 | 0;
  i10 = 0;
  i15 = i7;
  while (1) {
   i16 = i10 << 1;
   ...
   i18 = (i16 | 0) % 1024 | 0;
   i19 = (i8 + i10 | 0) % 1024 | 0;
   i20 = ((i10 | 0) % 255 | 0 | 0) % 1024 | 0;
   i21 = (i10 | 0) % 1024 | 0;
   i22 = ((i10 | 0) % 15 | 0 | 0) % 1024 | 0;
   i23 = (((i19 + i18 + i20 + i12 + i21 + i22 + ((i13 + i19 | 0) % 1024 | 0) + ((i14 + i18 | 0) % 1024 | 0) + ((i18 + i16 + i20 | 0) % 1024 | 0) + i11 + ((i9 + i21 | 0) % 1024 | 0) + ((((i17 | 0) % 1024 | 0) + i17 + i22 | 0) % 1024 | 0) | 0) % 100 | 0) + i15 | 0) % 10240 | 0;
   i10 = i10 + 1 | 0;
   if ((i10 | 0) == 5e4) {
    i24 = i23;
    break;
