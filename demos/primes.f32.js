...
__ATINIT__.push();
memoryInitializer = "primes.f32.js.mem";
...
function _printf_core(i1, i2, i3, i4, i5) {
 ...
 L1 : while (1) {
  ...
  while (1) {
   ...
   i46 = i45 + 1 | 0;
   i44 = HEAP8[3631 + (i43 * 58 | 0) + i47 >> 0] | 0;
   i47 = i44 & 255;
   if ((i47 + -1 | 0) >>> 0 < 8) {
    i45 = i46;
    i43 = i47;
    ...
    do if (i55 >>> 0 < 2146435072 | (i55 | 0) == 2146435072 & 0 < 0) {
     ...
     if ((i56 | 0) == 97) {
      ...
      while (1) {
       i114 = ~~d107;
       i115 = i113 + 1 | 0;
       HEAP8[i113 >> 0] = HEAPU8[4095 + i114 >> 0] | i45;
     ...
     if (!(i180 & 32)) ___fwritex(i113 ? (i106 ? 4155 : 4159) : i106 ? 4147 : 4151, 3, i1) | 0;
  ...
  L313 : do if ((i36 | 0) == 64) {
   ...
   if (!((i33 | 0) == 0 & (i55 | 0) == 0)) {
    ...
    while (1) {
     i55 = i45 + -1 | 0;
     HEAP8[i55 >> 0] = HEAPU8[4095 + (i106 & 15) >> 0] | i47;
...
function _main(i1, i2) {
 i1 = i1 | 0;
 i2 = i2 | 0;
 var i3 = 0, i4 = 0, i5 = 0, i6 = 0, i7 = 0, f8 = f0, i9 = 0, i10 = 0, i11 = 0;
 i2 = STACKTOP;
 ...
 i7 = 0;
 while (1) {
  f8 = Math_fround(Math_sqrt(Math_fround(i6 | 0)));
  L3 : do if (f8 > Math_fround(2.0)) {
   i9 = 2;
   while (1) {
    if (!((i6 | 0) % (i9 | 0) | 0)) {
     i10 = 0;
