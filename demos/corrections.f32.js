...
__ATINIT__.push();
memoryInitializer = "corrections.f32.js.mem";
...
function _printf_core(i1, i2, i3, i4, i5) {
 ...
 L1 : while (1) {
  ...
  while (1) {
   ...
   i46 = i45 + 1 | 0;
   i44 = HEAP8[3636 + (i43 * 58 | 0) + i47 >> 0] | 0;
   i47 = i44 & 255;
   if ((i47 + -1 | 0) >>> 0 < 8) {
    i45 = i46;
    i43 = i47;
    ...
    do if (i55 >>> 0 < 2146435072 | (i55 | 0) == 2146435072 & 0 < 0) {
     ...
     if ((i56 | 0) == 97) {
      ...
      while (1) {
       i114 = ~~d107;
       i115 = i113 + 1 | 0;
       HEAP8[i113 >> 0] = HEAPU8[4100 + i114 >> 0] | i45;
     ...
     if (!(i180 & 32)) ___fwritex(i113 ? (i106 ? 4160 : 4164) : i106 ? 4152 : 4156, 3, i1) | 0;
  ...
  L313 : do if ((i36 | 0) == 64) {
   ...
   if (!((i33 | 0) == 0 & (i55 | 0) == 0)) {
    ...
    while (1) {
     i55 = i45 + -1 | 0;
     HEAP8[i55 >> 0] = HEAPU8[4100 + (i106 & 15) >> 0] | i47;
...
function _main(i1, i2) {
 ...
 while (1) {
  ...
  i13 = i7;
  while (1) {
   i14 = ((i12 | 0) / (i9 | 0) | 0) + i11 | 0;
   if (i14 >>> 0 > 1e3) i15 = (i14 >>> 0) / (i10 >>> 0) | 0; else i15 = i14;
   if (!(i12 & 3)) i16 = i15 + (Math_imul((i12 & 7 | 0) == 0 ? 1 : -1, i12) | 0) | 0; else i16 = i15;
   i14 = i16 << 16 >> 16;
   i17 = (Math_imul(i14, i14) | 0) & 255;
   i14 = i17 + (i13 & 65535) | 0;
   i12 = i12 + 1 | 0;
   if ((i12 | 0) == 2e4) {
    i18 = i17;
